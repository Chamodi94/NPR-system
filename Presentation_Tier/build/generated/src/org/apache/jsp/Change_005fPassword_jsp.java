...
public final class Change_005fPassword_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                        <input type=\"password\" class=\"form-control\"  placeholder=\"Enter password\" name=\"txtnewpass\" required=\"\">\n");
      out.write("                    </div>\n");
      out.write("                    <button type=\"submit\" class=\"btn btn-default\" name=\"btnconfirm\">Confirm</button>\n");
      out.write("                </form>\n");
      out.write("\n");
      out.write("\n");
      out.write("            </div>\n");
...
if(request.getAttribute("success") =="failed"){
      ...
      out.write("   <script> alert(\"password changing failed\");\n");
      out.write("     </script>\n");
      out.write("     ");
...
if(request.getAttribute("success") =="success"){
      ...
      out.write("   <script> alert(\"password has been changed successfully\");\n");
      out.write("     </script>\n");
      out.write("     ");
