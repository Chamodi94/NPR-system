 ...
 * @author chamodi
 */
@WebServlet(name = "Vehicle_Info", urlPatterns = {"/Vehicle_Info"})
public class Vehicle_Info extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            String vehicelNo=request.getParameter("txtvehicleno");
            if(request.getParameter("btnsearch")!= null){
                request.setAttribute("vehicleinfo", proxy.searchvehicle(vehicelNo));
            }
